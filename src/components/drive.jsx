              ...
              {drivesHistory.map((drive) => (
                  <Accordion className='mt-3'>
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                      <Typography><span class="badge rounded-pill bg-secondary p-2 mx-3">Completed</span>  <i class="fas fa-calendar-check mx-3"></i>{dayjs(drive.date).format('MMMM, DD, YYYY')} <i class="fas fa-arrow-right-long mx-3"></i> {drive.start_location} <i class="fas fa-arrow-right-long mx-3"></i> {drive.end_location} </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography>
                        <div className='container-fluid'>
